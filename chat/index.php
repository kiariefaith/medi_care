               ...
               <nav class="main-menu">
                  ...
                  <div id="navbar" class="navbar-collapse collapse">
                     <ul class="nav navbar-nav">
                        ...
                        <li><a data-scroll href="../contact_us.php">Contact</a></li>
                     </ul>
                  </div>
               </nav>
            </div>
...
<div class = "widget">
            <div class = "widget-head">
             ~ Medi_Care ~ Explore a Location
            </div>
            <div class = "widget-content">
              <iframe  id="gmap_canvas" src="https://maps.google.com/maps?q=multimedia%20university%20nairobi&t=&z=13&ie=UTF8&iwloc=&output=embed"  width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
